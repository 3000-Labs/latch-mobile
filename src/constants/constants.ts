...
export const CIRCLE_USDC_CONTRACT = 'CCW67TSZV3SSS2HXMBQ5JFGCKJNXKZM7UQUWUZPUTHXSTZLEO7SJMI75';
...
export const FREIGHTER_GITHUB_ISSUE_URL = 'https://github.com/stellar/freighter-mobile/issues';
 ...
 */
export const isValidQRCodeSource = (source: string): source is QRCodeSourceType =>
  Object.values(QRCodeSource).includes(source as QRCodeSource);

/**
 * Helper function to get the default QR code source
 */
export const getDefaultQRCodeSource = (): QRCodeSource => QRCodeSource.ADDRESS_INPUT;
