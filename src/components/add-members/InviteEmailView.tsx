...
interface InviteEmailViewProps {
  onClose: () => void;
  onAdd: (name: string, email: string) => void;
}

const InviteEmailView: React.FC<InviteEmailViewProps> = ({ onClose, onAdd }) => {
  ...
  return (
    <Formik
      ...
      onSubmit={(values) => onAdd(values.name.trim(), values.email.trim())}
    >
...
export default InviteEmailView;
