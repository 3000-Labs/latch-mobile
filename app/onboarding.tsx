...
const ONBOARDING_DATA = [
    {
        ...
        description: 'Your secure gateway to the Stellar ecosystem. Manage your digital assets with confidence and simplicity.',
        image: require('@/src/assets/images/ob1.png'),
    },
    {
        id: 2,
        title: 'Smart Accounts',
        description: 'Experience enhanced security with Smart Accounts. Advanced features abstracted into a simple, user-friendly interface.',
        image: require('@/src/assets/images/ob3.png'),
    },
    {
        id: 3,
        title: 'Seamless Funding',
        description: 'Fund your Smart Account easily using traditional Stellar G-addresses with memos. We handle the complexity for you.',
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <Box width={width} alignItems="center" paddingTop="xl">
                        {/* Background Symbols */}
                        <Box position="absolute" top={100} left={30} opacity={0.1}>
                            <Image source={require('@/src/assets/images/logosym.png')} style={{ width: 60, height: 60, transform: [{ rotate: '-15deg' }] }} />
                        </Box>
                        <Box position="absolute" bottom={300} right={20} opacity={0.1}>
                            <Image source={require('@/src/assets/images/logosym.png')} style={{ width: 80, height: 80, transform: [{ rotate: '15deg' }] }} />
                        </Box>
