...
const Biometrics = () => {
  ...
  return (
    <Box flex={1} backgroundColor="mainBackground" paddingHorizontal="xl" paddingTop="xl" paddingBottom="none">
      ...
      >
        <Box flexDirection="row" alignItems="center" flex={1}>
          <Box marginRight="m">
            <Image source={require('@/src/assets/images/face_id.png')} style={{ width: 24, height: 24, objectFit:"contain" }} />
          </Box>
          <Box flex={1}>
